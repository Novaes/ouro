...
function genconvolution(NB,NBF,RM,RN,V,K,L,NF,thsize)	
	...
	local l1conv0 = genkernel(NB, RM, RN, V, true, K, L, NF, false)
    local l1conv0b = genkernel(NB, 1, 1, V, false, K, L, NF, true)
					...
					for _,rm in ipairs(regblocks) do
						for _,rn in ipairs(regblocks) do
							for _,v in ipairs(vectors) do
									...
									local my_conv = genconvolution(b,NB2,rm,rn,v,k,k,f,t)
...
-- local my_convolution = genconvolution(best.b,NB2,best.rm,best.rn,best.v,best.k,best.k,best.f,best.t,best.jobs)
