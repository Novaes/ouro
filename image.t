//source https://github.com/jameshegarty/darkroom/blob/master/extras/image.t
...
local terra loadAndRun(argc: int, argv: &rawstring) --gettime : {} -> double
  ...
  --convolution operation/use dgemm, transpose version (dot product)
